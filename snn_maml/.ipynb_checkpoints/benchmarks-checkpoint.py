...
def get_benchmark_by_name(name,
    ...
    if name == 'omniglot':
        ...
        data_dir = folder+'/../../data/n_mnist.hdf5'
        ...
        root_dvssign = folder+'/../../data/dvssign.hdf5'
        ...
        print("data is here", folder)
        data_dir = folder+'/../../data/dvssign.hdf5'
        ...
        data_dir = folder+'/../data/emg_meta_one.hdf5'#folder+'/data/nomniglot/nomniglot.hdf5'
